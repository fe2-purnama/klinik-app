...
const DoctorProfile = ({ profile }) => (
    <div className="bg-white shadow-md rounded-lg p-6">
        <h3 className="text-xl md:text-2xl font-medium text-gray-700 mb-4">Profil Dokter</h3>
        <div>
            <div className="py-2">
                <p className="text-lg md:text-xl font-semibold text-gray-600">Nama Lengkap</p>
            ...
            <div className="py-2">
                <p className="text-lg md:text-xl font-semibold text-gray-600">Jenis Kelamin</p>
                <p className="text-lg text-gray-600">{profile.gender}</p>
            </div>
            <div className="py-2">
                <p className="text-lg md:text-xl font-semibold text-gray-600">Nomor Telepon</p>
                <p className="text-lg text-gray-600">{profile.phone_number}</p>
            </div>
            <div className="py-2">
                <p className="text-lg md:text-xl font-semibold text-gray-600">Spesialisasi</p>
                <p className="text-lg text-gray-600">{profile.specialization}</p>
            </div>
            <div className="py-2">
                <p className="text-lg md:text-xl font-semibold text-gray-600">Pengalaman</p>
    ...
    return (
        <div className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
            <div className="container px-6 py-8 mx-auto">
                <h2 className='text-2xl md:text-3xl font-medium text-gray-700'>Profil</h2>
                <div className="flex flex-col md:flex-row md:space-x-6 bg-gray-200 py-8">
                    ...
                    <div className="flex-1 bg-white shadow-md rounded-lg p-6 mt-6 md:mt-0">
                        <h3 className="text-xl md:text-2xl font-medium text-gray-700 mb-4">Ubah Profil</h3>
