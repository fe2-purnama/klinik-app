    ...
    <section>
      ...
      <div className="flex flex-col lg:flex-row gap-8 w-full h-fit my-6">
        ...
        <div className="flex flex-col gap-3">
          <h1 className="text-lg md:text-2xl font-semibold">dr. Andika Satria Wibowo, Sp. M</h1>
          ...
          <div className="flex flex-row items-start gap-5 py-4 overflow-x-auto">
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="px-2 py-1 bg-slate-200 text-sm rounded-md w-28">08.00 - 10.00</p>
            </div>
            <div className="flex flex-col items-center gap-2">
              <div className="flex flex-row gap-2 items-center">
