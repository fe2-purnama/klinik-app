...
const Sidebar = (props) => {
  ...
  return (
    <>
      <aside
        className={`fixed inset-y-0 left-0 z-20 w-64 bg-white border-r-2 lg:relative lg:w-auto lg:flex lg:border-none transition-transform duration-300 ${
      ...
      >
        <ul className="flex flex-col justify-between h-full space-y-2 font-medium">
          <li>
            ...
            <button
              className={`absolute top-4 right-4 shadow-none bg-white ${
                isShow ? "block" : "hidden"
              } lg:hidden`}
              onClick={handleClick}
            >
          ...
          <li className="mt-auto p-4">
            <button
              className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-blue-100"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg p-6">
            ...
            <div className="flex justify-end mt-4">
              <button
                className="mr-4 bg-gray-200 px-4 py-2 rounded-lg"
