  ...
  return (
    <div className="accordion">
      <h2 className="accordion-heading">
        <button type="button" className={`flex items-center justify-between w-full p-5 font-medium text-gray-500 gap-3 text-sm lg:text-base ${isOpen ? 'open' : ''}`} aria-expanded={isOpen} onClick={toggleAccordion}>
          <span>{title}</span>
