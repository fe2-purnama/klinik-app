    ...
    <Table className="border-none drop-shadow-none">
      ...
      <TableBody className="divide-y">
        {reservations.map((reservation, index) => (
          <TableRow key={index}>
            <TableCell className="whitespace-nowrap font-medium text-gray-900">{index + 1}</TableCell>
            ...
            <TableCell>
              <a onClick={() => alert('batal')} className="font-medium text-red-600 hover:underline">
                batal
              </a>
            </TableCell>
          </TableRow>
