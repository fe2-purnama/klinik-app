...
const services = [
    {
        ...
        description: (
            <div className="flex flex-col md:flex-row justify-between p-8">
                ...
                <img
                    src={Layanan1}
                    alt="Dokter melakukan konsultasi"
        ...
        description: (
            <div className="flex flex-col md:flex-row justify-between p-8">
                <div>
                    ...
                    <ol className="list-decimal pl-6">
                        <li>Masuk ke halaman <b>Homepage</b></li>
                        <li>Klik menu bagian <b>Hubungi Kami</b></li>
                        <li>Isi formulir dengan memilih jenis pesan <b>Permintaan</b></li>
                        <li>Anda akan diarahkan ke <b>WhatsApp</b> resmi kami</li>
        ...
        description: (
            <div className="flex flex-col md:flex-row justify-between p-8">
                <div>
                    ...
                    <ol className="list-decimal pl-6">
                        <li>Datang ke klinik sesuai <b>jadwal</b> klinik</li>
                        <li>Pergi ke bagian <b>Administrasi</b></li>
                        <li>Sampaikan bahwa anda ingin ke <b>Laboratorium</b></li>
                        <li>Isi formulir yang tertera</li>
                        <li>Tunggu dan anda akan segera diarahkan ke <b>Laboratorium</b></li>
                    </ol>
                </div>
                <img
                    src={Layanan5}
